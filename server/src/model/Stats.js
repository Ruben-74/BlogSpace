    ...
    try {
      const [results] = await pool.execute(
        ...
        SELECT 
            ...
            (SELECT COUNT(*) FROM post p JOIN comment c ON p.id = c.post_id) AS posts_with_comments,
            ...
            (SELECT COUNT(*) FROM comment WHERE status = 'validé') AS approved_comment_count,
